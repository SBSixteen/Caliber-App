                          ...
                          Column(
                            ...
                            children: [
                              Transform.translate(
                                ...
                                child: Text(
                                  constants.formatter.format(widget.weapon.WeaponPrice*widget.weapon.WeaponDiscount),
                                  style: TextStyle(
                                      fontFamily: "Inter Bold",
                                      fontSize: 24,
                                      color: (widget.weapon.WeaponPrice*widget.weapon.WeaponDiscount < widget.weapon.WeaponPrice)
                              ...
                              Transform.translate(
                                ...
                                child: Text(
                                  constants.formatter.format(widget.weapon.WeaponPrice),
                                  style: const TextStyle(
                                      fontFamily: "Inter",
                                      fontSize: 12,
